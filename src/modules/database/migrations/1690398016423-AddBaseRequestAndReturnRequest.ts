...
export class AddBaseRequestAndReturnRequest1690398016423 implements MigrationInterface {
    name = 'AddBaseRequestAndReturnRequest1690398016423'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "order_return_request_item" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "quantity" integer NOT NULL, "approved" boolean NOT NULL DEFAULT false, "orderItemId" uuid, "orderReturnRequestedId" uuid, "orderReturnApprovedId" uuid, CONSTRAINT "REL_5f2d3c195e47f20f7654066df7" UNIQUE ("orderItemId"), CONSTRAINT "PK_d48c24c652059f4ff24cea178f5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "order_return_request" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deduction" numeric(10,2) NOT NULL DEFAULT '0', "total" numeric(10,2) NOT NULL DEFAULT '0', "status" "public"."order_return_request_status_enum" NOT NULL DEFAULT 'Pending', "deliveryId" uuid, "orderId" uuid, CONSTRAINT "REL_7da2ae19465bd98abd46222401" UNIQUE ("deliveryId"), CONSTRAINT "REL_d833ca1da5bf2c48d12e75ba1e" UNIQUE ("orderId"), CONSTRAINT "PK_73fd87212600e343b25ede4136d" PRIMARY KEY ("id"))`);
