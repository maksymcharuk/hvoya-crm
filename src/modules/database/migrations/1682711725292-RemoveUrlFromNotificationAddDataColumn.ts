  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "notification" RENAME COLUMN "url" TO "data"`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "notification" DROP COLUMN "data"`);
    await queryRunner.query(
      `ALTER TABLE "notification" ADD "data" character varying NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "notification" RENAME COLUMN "data" TO "url"`,
    );
  }
}
