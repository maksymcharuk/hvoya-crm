  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "product_category" (
        ...
        CONSTRAINT "UQ_96152d453aaea425b5afde3ae9f" UNIQUE ("name"),
    ...
    await queryRunner.query(
      `CREATE TABLE "product_base" (
        ...
        "name" character varying NOT NULL,
        "categoryId" integer,
        CONSTRAINT "UQ_56b87ec6ea1358296853b748f7c" UNIQUE ("name"),
        CONSTRAINT "PK_13bac3fda6ce20723dd774c39f0" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_base"
        ADD CONSTRAINT "FK_baa9383d47c877117fd66feea42" 
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "product_base" 
        DROP CONSTRAINT "FK_baa9383d47c877117fd66feea42"`,
    );
