...
export class UpdateProductVariantImagesAndAddedFilesEntity1675450810211 implements MigrationInterface {
    name = 'UpdateProductVariantImagesAndAddedFilesEntity1675450810211'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "file" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "public_id" character varying NOT NULL, "url" character varying NOT NULL, "productVariantId" integer, CONSTRAINT "PK_36b46d232307066b3a2c9ea3a1d" PRIMARY KEY ("id"))`);
