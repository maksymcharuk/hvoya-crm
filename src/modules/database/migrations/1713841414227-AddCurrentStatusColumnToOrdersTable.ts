  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."order_currentstatus_enum" AS ENUM('Pending', 'Processing', 'TransferedToDelivery', 'Fulfilled', 'Cancelled', 'Refunded', 'Refused')`,
    );
    await queryRunner.query(
      `ALTER TABLE "order" ADD "currentStatus" "public"."order_currentstatus_enum" NOT NULL DEFAULT 'Pending'`,
    );
  }
